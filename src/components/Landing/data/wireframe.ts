// Copy and data transcribed verbatim from the approved homepage wireframe.
// Source of truth: the published artifact. Do not reword — see docs/wireframe-copy.txt.
